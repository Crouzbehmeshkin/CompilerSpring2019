...
public class Parser {
    ...
    public  void addToFisrtSet( HashMap<String , ArrayList> firstSets  ){
       ...
       first.add("EOF");first.add("int"); first.add("void");
        ...
        first1.add("ε");first1.add("int");first1.add("void");
        ...
        first9.add("{");first9.add("continue");first9.add("break");first9.add(";");first9.add("if"); first9.add("ε");
        ...
        first12.add(";") ; first12.add("ID"); first12.add("+"); first12.add("-"); first12.add("(");first12.add("NUM");
            ...
            first11.clear(); first11.add("case"); first11.add("ε");
            firstSets.put("case-stmt" , first11);
            firstSets.put("case-stmtB" , first11);
            first11.remove("ε");
            firstSets.put("case-stmt" , first11);
            first11.clear(); first11.add("default") ; first11.add("ε");
